...
# The app will look for a secret named "tmdb_api_key" hidden in the server settings
...
# --- TMDB Genre Mapping ---
GENRE_MAP = { ... } # (Keep the rest of the maps and layout columns exactly the same)
